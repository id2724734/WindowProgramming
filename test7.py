...
class MyFrame1(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_txtName1 = wx.StaticText(self.m_panel1, wx.ID_ANY, u"이름 :", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_txtName1.Wrap(-1)
        bSizer2.Add(self.m_txtName1, 0, wx.ALL, 5)
        ...
        self.m_txtAge1 = wx.StaticText(self.m_panel2, wx.ID_ANY, u"나이 :", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_txtAge1.Wrap(-1)
        bSizer3.Add(self.m_txtAge1, 0, wx.ALL, 5)
